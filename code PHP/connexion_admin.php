    ...
    <div id="container">
         <form action="" method="post">
            <h1>Administrateur</h1>  
                ...
                <input type="text" id="id_admin" name="id_admin" pattern="[0-9]+" maxlength="30" required><br/>
...
if(isset($_POST['id_admin']) && isset($_POST['password']) ){
        if(!empty($_POST['id_admin']) && !empty($_POST['password'])){
        $_SESSION['id_admin']=$_POST['id_admin'];
        $_SESSION['password']=$_POST['password'];
        authenticate_admin();
    }elseif(isset($_SESSION['id_admin']) && isset($_SESSION['password'])){
        authenticate_admin();
    }} 
                ?>
